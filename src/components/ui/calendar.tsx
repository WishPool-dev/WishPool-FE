...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'data-[selected-single=true]:bg-blue-primary data-[range-middle=true]:bg-blue-6 data-[range-start=true]:bg-blue-primary data-[range-end=true]:bg-blue-primary group-data-[focused=true]/day:border-blue-primary group-data-[focused=true]/day:ring-blue-primary/50 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 !text-[1.4rem] leading-none font-medium group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-end=true]:text-white data-[range-middle=true]:rounded-none data-[range-middle=true]:text-white data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md data-[range-start=true]:text-white data-[selected-single=true]:text-white dark:hover:text-white',
        defaultClassNames.day,
        className,
      )}
      {...props}
